...
replace (
	...
	github.com/slighter12/go-lib/database/valkey/cluster => ./database/valkey/cluster
	github.com/slighter12/go-lib/database/valkey/sentinel => ./database/valkey/sentinel
	github.com/slighter12/go-lib/database/valkey/single => ./database/valkey/single
)
